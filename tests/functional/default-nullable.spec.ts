...
describe('buildSchema -> nullableByDefault', () => {
    ...
    describe('default behavior', () => {
        ...
        beforeEach(async () => {
            ...
            container.bind('SampleResolverClass', SampleResolverClass);
            router.query('normalQuery', 'SampleResolverClass.normalQuery');
            router.query('normalArrayQuery', 'SampleResolverClass.normalArrayQuery');
            router.query('nullableQuery', 'SampleResolverClass.nullableQuery');
            router.query('nonNullableQuery', 'SampleResolverClass.nonNullableQuery');
