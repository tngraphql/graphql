...
import { IntrospectionInputObjectType, IntrospectionObjectType, IntrospectionSchema, } from 'graphql';

import { Arg, Args, ArgsType, Field, InputType, Mutation, ObjectType, Query, Resolver, } from '../../src';
...
describe('Description', () => {
    describe('Schema', () => {
        ...
        beforeAll(async () => {
            ...
            router.query('describedQuery', 'SampleResolver.describedQuery')
            router.query('argumentedQuery', 'SampleResolver.argumentedQuery')
            router.query('inputQuery', 'SampleResolver.inputQuery')

            router.mutation('normalMutation', 'SampleResolver.normalMutation');
            router.mutation('describedMutation', 'SampleResolver.describedMutation');
            router.mutation('argumentedMutation', 'SampleResolver.argumentedMutation');
            router.mutation('inputMutation', 'SampleResolver.inputMutation');
