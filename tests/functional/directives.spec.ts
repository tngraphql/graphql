...
import { graphql, GraphQLInputObjectType, GraphQLSchema } from 'graphql';
import {
    Arg,
    buildSchema,
    Directive,
...
describe('Directives', () => {
    ...
    describe('Schema', () => {
        beforeAll(async () => {
            ...
            router.query('objectType', 'SampleResolver.objectType');
            router.query('queryWithDirective', 'SampleResolver.queryWithDirective');
            router.query('queryWithUpper', 'SampleResolver.queryWithUpper');
            router.query('queryWithUpperDefinition', 'SampleResolver.queryWithUpperDefinition');
            router.query('queryWithAppend', 'SampleResolver.queryWithAppend');
            router.query('queryWithAppendDefinition', 'SampleResolver.queryWithAppendDefinition');
            router.query('queryWithUpperAndAppend', 'SampleResolver.queryWithUpperAndAppend');
            router.mutation('mutationWithDirective', 'SampleResolver.mutationWithDirective');
            router.mutation('mutationWithUpper', 'SampleResolver.mutationWithUpper');
            router.mutation('mutationWithUpperDefinition', 'SampleResolver.mutationWithUpperDefinition');
            router.mutation('mutationWithAppend', 'SampleResolver.mutationWithAppend');
            router.mutation('mutationWithAppendDefinition', 'SampleResolver.mutationWithAppendDefinition');
            router.mutation('mutationWithUpperAndAppend', 'SampleResolver.mutationWithUpperAndAppend');
            router.subscription('subscriptionWithDirective', 'SampleResolver.subscriptionWithDirective');
