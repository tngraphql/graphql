...
describe('Extensions', () => {
    ...
    describe('Schema', () => {
        beforeAll(async () => {
            ...
            router.query('sampleObjectType', 'SampleResolver.sampleObjectType');
            router.query('extensionsOnClassObjectType', 'SampleResolver.extensionsOnClassObjectType');
            router.query('queryWithExtensions', 'SampleResolver.queryWithExtensions');
            router.query('queryWithMultipleExtensions', 'SampleResolver.queryWithMultipleExtensions');
            router.query('queryWithMultipleExtensionsDecorators', 'SampleResolver.queryWithMultipleExtensionsDecorators');
            router.mutation('mutationWithExtensions', 'SampleResolver.mutationWithExtensions');
            router.mutation('mutationWithMultipleExtensions', 'SampleResolver.mutationWithMultipleExtensions');
            router.mutation('mutationWithMultipleExtensionsDecorators', 'SampleResolver.mutationWithMultipleExtensionsDecorators');
