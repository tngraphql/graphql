...
describe('MetadataStorage', () => {
    describe('resolvers inheritance', () => {
        ...
        beforeAll(async () => {
            ...
            container.bind('SampleResolver', SubClassResolver);
            router.query('subClassQuery', 'SampleResolver.subClassQuery');
            router.mutation('subClassMutation', 'SampleResolver.subClassMutation');
            router.subscription('subClassSubscription', 'SampleResolver.subClassSubscription');
