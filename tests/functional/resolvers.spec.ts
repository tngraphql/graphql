...
import { isThrowing } from '../../src/helpers/isThrowing';
...
describe('Resolvers', () => {
    describe('Schema', () => {
        ...
        beforeAll(async () => {
            ...
            router.query('emptyQuery', 'SampleResolver.emptyQuery');
            router.query('implicitStringQuery', 'SampleResolver.implicitStringQuery');
            router.query('explicitStringQuery', 'SampleResolver.explicitStringQuery');
            router.query('nullableStringQuery', 'SampleResolver.nullableStringQuery');
            router.query('implicitStringArrayQuery', 'SampleResolver.implicitStringArrayQuery');
            router.query('explicitStringArrayQuery', 'SampleResolver.explicitStringArrayQuery');
            router.query('explicitNullableItemArrayQuery', 'SampleResolver.explicitNullableItemArrayQuery');
            router.query('explicitNullableArrayWithNullableItemsQuery', 'SampleResolver.explicitNullableArrayWithNullableItemsQuery');
            router.query('promiseStringQuery', 'SampleResolver.promiseStringQuery');
            router.query('implicitObjectQuery', 'SampleResolver.implicitObjectQuery');
            router.query('asyncObjectQuery', 'SampleResolver.asyncObjectQuery');
            router.query('rootCtxQuery', 'SampleResolver.rootCtxQuery');
            router.query('argQuery', 'SampleResolver.argQuery');
            router.query('argsQuery', 'SampleResolver.argsQuery');
            router.query('argAndArgsQuery', 'SampleResolver.argAndArgsQuery');
            router.query('argsInheritanceQuery', 'SampleResolver.argsInheritanceQuery');
            router.mutation('emptyMutation', 'SampleResolver.emptyMutation');
        ...
        describe('Errors', () => {
            ...
            it('should throw error when creating field resolver in resolver with no object type info', async () => {
                ...
                try {
                    ...
                    const router = new Router();
                    const container = new DefaultContainer();
                    container.bind('SampleResolverWithError', SampleResolverWithError);
                    router.query('sampleQuery', 'SampleResolverWithError.sampleQuery');
    ...
    describe('Functional', () => {
      ...
      `;
        ...
        beforeAll(async () => {
            ...
            container.bind('SampleResolver', SampleResolver);
            router.query('sampleQuery', 'SampleResolver.sampleQuery');
            router.query('notInstanceQuery', 'SampleResolver.notInstanceQuery');
            router.query('queryWithRootContextAndInfo', 'SampleResolver.queryWithRootContextAndInfo');
            router.query('queryWithPartialRootAndContext', 'SampleResolver.queryWithPartialRootAndContext');
            router.query('queryWithCustomDecorators', 'SampleResolver.queryWithCustomDecorators');
            router.query('queryWithCustomDescriptorDecorator', 'SampleResolver.queryWithCustomDescriptorDecorator');
            router.mutation('mutationWithArgs', 'SampleResolver.mutationWithArgs');
            router.mutation('mutationWithOptionalArgs', 'SampleResolver.mutationWithOptionalArgs');
            router.mutation('mutationWithInput', 'SampleResolver.mutationWithInput');
            router.mutation('mutationWithNestedInputs', 'SampleResolver.mutationWithNestedInputs');
            router.mutation('mutationWithNestedArgsInput', 'SampleResolver.mutationWithNestedArgsInput');
            router.mutation('mutationWithInputs', 'SampleResolver.mutationWithInputs');
            router.mutation('mutationWithOptionalArg', 'SampleResolver.mutationWithOptionalArg');
    ...
    describe('buildSchema', () => {
        ...
        it('should build the schema synchronously', async () => {
            ...
            const container = new DefaultContainer();
            container.bind('SampleResolver', SampleResolver);
            router.query('sampleQuerySync', 'SampleResolver.sampleQuerySync');
      ...
      `;
        ...
        it('should generate the schema when schema is incorrect but `skipCheck` is set to true', async () => {
            ...
            const container = new DefaultContainer();
            container.bind('SampleResolver', SampleResolver);
            router.mutation('sampleMutation', 'SampleResolver.sampleMutation');
        ...
        it('should throw errors when no resolvers provided', async () => {
            ...
            try {
                const router = new Router();
                await buildSchema({ router });
            } catch (err) {
                expect(err.message).toContain('Generating schema error');
    ...
    describe('Inheritance', () => {
        ...
        it('isThrowing', async () => {
            expect(isThrowing(null)).toEqual(true);
            expect(isThrowing(() => 1)).toEqual(false);
        });
    });
});
