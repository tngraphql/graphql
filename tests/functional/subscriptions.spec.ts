...
describe('Subscriptions', () => {
    describe('Schema', () => {
        ...
        beforeAll(async () => {
            ...
            router.subscription('sampleSubscription', 'SampleResolver.sampleSubscription');
            router.subscription('subscriptionWithArgs', 'SampleResolver.subscriptionWithArgs');
            router.subscription('subscriptionWithExplicitType', 'SampleResolver.subscriptionWithExplicitType');
    ...
    describe('Functional', () => {
        ...
        beforeAll(async () => {
            ...
            const container = new DefaultContainer();
            container.bind('SampleResolver', SampleResolver);
            router.query('dummyQuery', 'SampleResolver.dummyQuery');
            router.mutation('pubSubMutation', 'SampleResolver.pubSubMutation');
            router.mutation('pubSubMutationCustomSubscription', 'SampleResolver.pubSubMutationCustomSubscription');
            router.mutation('pubSubMutationDynamicTopic', 'SampleResolver.pubSubMutationDynamicTopic');
            router.mutation('pubSubPublisherMutation', 'SampleResolver.pubSubPublisherMutation');
            router.mutation('pubSubOtherMutation', 'SampleResolver.pubSubOtherMutation');
            router.subscription('sampleTopicSubscription', 'SampleResolver.sampleTopicSubscription');
            router.subscription('sampleTopicSubscriptionWithFilter', 'SampleResolver.sampleTopicSubscriptionWithFilter');
            router.subscription('multipleTopicSubscription', 'SampleResolver.multipleTopicSubscription');
            router.subscription('dynamicTopicSubscription', 'SampleResolver.dynamicTopicSubscription');
            router.subscription('customSubscribeSubscription', 'SampleResolver.customSubscribeSubscription');
      ...
      `;
        ...
        pubSubMutation
            ...
            const container = new DefaultContainer();
            container.bind('SampleResolver', SampleResolver);
            router.query('dumbQuery', 'SampleResolver.dumbQuery');
            router.mutation('pubSubMutation', 'SampleResolver.pubSubMutation');
