...
import {
    Arg,
    buildTypeDefsAndResolvers, ContainerType,
    createUnionType,
    Field,
    InputType,
    InterfaceType,
...
describe('buildTypeDefsAndResolvers', () => {
    ...
    beforeAll(async () => {
        ...
        router.query('sampleDateQuery', 'SampleResolver.sampleDateQuery');
        router.query('sampleServiceQuery', 'SampleResolver.sampleServiceQuery');
        router.query('sampleMiddlewareBooleanQuery', 'SampleResolver.sampleMiddlewareBooleanQuery');
        router.mutation('sampleBooleanMutation', 'SampleResolver.sampleBooleanMutation');
        router.mutation('sampleMutationWithInput', 'SampleResolver.sampleMutationWithInput');
        router.mutation('sampleAuthorizedMutation', 'SampleResolver.sampleAuthorizedMutation');
        router.query('sampleInterfaceQuery', 'SampleResolver.sampleInterfaceQuery');
        router.query('sampleUnionQuery', 'SampleResolver.sampleUnionQuery');
        router.query('sampleResolveUnionQuery', 'SampleResolver.sampleResolveUnionQuery');
        router.query('sampleNumberEnumQuery', 'SampleResolver.sampleNumberEnumQuery');
        router.query('sampleStringEnumQuery', 'SampleResolver.sampleStringEnumQuery');
