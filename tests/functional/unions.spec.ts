...
import { createUnionType, Field, ObjectType, Query } from '../../src';
...
describe('Unions', () => {
    ...
    beforeAll(async () => {
        ...
        router.query('getObjectOneFromUnion', 'SampleResolver.getObjectOneFromUnion');
        router.query('getObjectOneFromUnionFn', 'SampleResolver.getObjectOneFromUnionFn');
        router.query('getObjectWithUnion', 'SampleResolver.getObjectWithUnion');
        router.query('getPlainObjectFromUnion', 'SampleResolver.getPlainObjectFromUnion');
        router.query('getObjectOneFromStringResolveTypeUnion', 'SampleResolver.getObjectOneFromStringResolveTypeUnion');
        router.query('getObjectOneFromClassResolveTypeUnion', 'SampleResolver.getObjectOneFromClassResolveTypeUnion');
